...
namespace RaspKurs
{
    ...
    public partial class MainWindow : Window
    {
        ...
        {
            InitializeComponent();
            AppConnect.model0db = new RaspEntities2();
            Manager.MainFrame = MainFrame;
            Manager.FormFrame = FormFrame;

            Manager.MainFrame.Navigate(new LoginUI());
        }
        ...
        {
            Manager.FormFrame.Navigate(new FormaSUBJ());
        }

        private void Prepod_Click(object sender, RoutedEventArgs e)
        {
            Manager.FormFrame.Navigate(new FormaPR());
        }

        private void Audit_Click(object sender, RoutedEventArgs e)
        {
            Manager.FormFrame.Navigate(new FornaAUDIT());
        }
